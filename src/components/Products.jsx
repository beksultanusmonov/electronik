  ...
  return (
    <div className='flex py-18 gap-3 mx-auto flex-col max-w-[94vw] w-[900px]'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <span className='font-semibold text-xl'>Mahsulot toifasiga umumiy nuqtai</span>
        </div>
        <h1 className='text-4xl font-bold'>Relelar</h1>
        <p className='my-10'>Hongfa o'rni mahsulotlariga quvvat o'rni (umumiy maqsadli o'rni), avtomobil o'rni, yuqori kuchlanishli shahar o'rni (DC kontaktorlari), qulflash o'rni, signal o'rni, sanoat o'rni va boshqalar kiradi. Shuningdek, biz mos keladigan o'rni rozetkalarini taqdim etamiz. Hongfa o'rni 160 dan ortiq seriyali, 40 000 dan ortiq umumiy xususiyatlarni o'z ichiga oladi, yillik ishlab chiqarish quvvati 3 milliard donadan ortiq bo'lib, mahsulotlar UL / C-UL, VDE, TÜV, CQC va boshqa xavfsizlik sertifikatlari bilan sertifikatlangan.</p>
        ...
        <div className='w-full flex flex-wrap gap-x-10 gap-y-20 justify-center'>
          {products.map(data => {
            return <div key={data.title} className="w-[420px] py-5 px-2 relative border border-blue-800 group z-10">
            <img src={data.img} className='tran hover:scale-120 z-20 max-h-[280px]' />
            <div className="absolute w-[90%] shadow-md z-30 h-18 border-b-2 border-b-cyan-500 flex items-center">
              <div className="w-[20%] bg-blue-900 h-full flex items-center justify-center"><i class="fa-solid fa-car-battery text-white text-3xl"></i></div>
